...
with lib; {
  ...
  my.home.systemd.user.services.spdiflisten = {
    ...
    Service = {
      ...
      ExecStart = "${pkgs.pipewire}/bin/pw-link alsa_input.pci-0000_05_00.0.iec958-stereo:capture_FL alsa_output.usb-Topping_D10-00.analog-stereo:playback_FL";
      ExecStartPost = "${pkgs.pipewire}/bin/pw-link alsa_input.pci-0000_05_00.0.iec958-stereo:capture_FR alsa_output.usb-Topping_D10-00.analog-stereo:playback_FR";
      Type = "oneshot";
    };
  };
